...
def compute_motion_plan(task_plan,bodyUniqueId,endEffectorLinkIndex_left,endEffectorLinkIndex_right,init_position_left,init_position_right,init_orientation_left,init_orientation_right):
	...
	return motion_plan_left,motion_plan_right
...
if __name__ == "__main__":
	...
	print(task_plan)
	motion_plan_left,motion_plan_right = compute_motion_plan(task_plan,bodyUniqueId,endEffectorLinkIndex_left,endEffectorLinkIndex_right,
	...
	#print("The size of motion_plan_left is: ",motion_plan_left.shape)
	motion_plan_left,motion_plan_right = pad(motion_plan_left,motion_plan_right)
	...
	while True:
		if executed == False and time>time_max:
			print("Executing")
			for k in range(0,len(motion_plan_left)):
				...
				leftEEF_position = motion_plan_left[k]
				rightEEF_position = motion_plan_right[k]
