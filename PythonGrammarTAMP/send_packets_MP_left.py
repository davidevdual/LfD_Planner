...
initialStatesList = [[100,-300,-200,0.4279,0.3251,-0.6029,0.5897],[0,-300,-200,0.5240,0.2169,-0.6533,0.5014],[-100,-300,-300,0.4141,0.2051,-0.8388,0.2879],[0,-300,-300 ,0.3747,0.2668,-0.7946,0.3963]];
finalStatesList = [[0,-300,-200,0.5240,0.2169,-0.6533,0.5014],[-100,-300,-300,0.4141,0.2051,-0.8388,0.2879],[0,-300,-300,0.3747,0.2668,-0.7946,0.3963],[100,-300,-200,0.4279,0.3251,-0.6029,0.5897]];
arm_left = 1;
arm_right = 0;
waypoints_left = motion_planner.generate_waypoints_listStates(initialStatesList,finalStatesList,arm_left);

# Compute the angles corresponding to each waypoint
angles_left = motion_planner.convert_jointSpace(waypoints_left,arm_left);
angles_right = np.zeros([np.size(angles_left,0),5]);
