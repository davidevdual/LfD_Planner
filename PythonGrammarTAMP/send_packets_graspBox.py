...
waypoint2 = np.array([0,20,0,0,0,270,0,0,0,0,0,0,20,0,0,0,270,0,0,0,0,0])# Order: LSR, LSA, LEFE, LSFE, LWR, RSR, RSA, REFE, RSFE, RWR
times12_final = 2
times23_init = 0

waypoint3 = np.array([0,20,90,0,0,270,0,0,0,0,0,0,20,90,0,0,270,0,0,0,0,0])
times23_final = 2
times34_init = 0

waypoint4 = np.array([0,20,90,0,-90,270,0,0,0,0,0,0,20,90,0,-120,270,0,0,0,0,0])
times34_final = 2
times45_init = 0

waypoint5 = np.array([0,20,150,0,-90,270,0,0,0,0,0,0,20,150,0,-120,270,0,0,0,0,0])
times45_final = 2
times56_init = 0

waypoint6 = np.array([0,20,150,0,-90,270,0,0,0,0,0,0,20,150,0,-120,270,0,0,0,0,0])
times56_final = 2

waypoints_forward = [waypoint1,waypoint2,waypoint3,waypoint4,waypoint5,waypoint6]#waypoint1 must be included in the waypoints
waypoints_backward = [waypoint5,waypoint4,waypoint3,waypoint2,waypoint1]
