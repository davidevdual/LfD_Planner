...
def compute_task_plan():
	...
	return task_planner.get_plan(),task_planner.get_total_taskPlanning_time()
...
if __name__ == "__main__":
	...
	for k in range(0,100):
		task_plan,task_plan_time = compute_task_plan()
		motion_plan_left,motion_plan_right,motion_plan_time = compute_motion_plan(task_plan,bodyUniqueId,endEffectorLinkIndex_left,endEffectorLinkIndex_right,
		...
		results_taskPlan_time.append(task_plan_time)
		results_motionPlan_time.append(motion_plan_time)
		results_totalPlan_time.append(task_plan_time+motion_plan_time)
		...
		np.save('results_taskPlanClassical_'+ff_type+'_matrix.npy', results_taskPlan_matrix)
		np.save('results_motionPlanClassical_'+ff_type+'_matrix.npy', results_motionPlan_matrix)
		np.save('results_totalPlanClassical_'+ff_type+'_matrix.npy', results_totalPlan_matrix)
		print("task plan time is: ",task_plan_time," and motion plan is: ",motion_plan_time, " together: ",task_plan_time+motion_plan_time)